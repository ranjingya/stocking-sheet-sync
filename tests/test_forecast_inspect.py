...
def test_company_pending_blocks_only_fallback_platform():
    ...
    assert pdd["issues"] == ["company_scope_pending_confirmation"]
...
@pytest.mark.parametrize("problem", ["missing", "duplicate", "mismatch", "invalid", "null_id"])
def test_daily_integrity_blocks_quantity(problem):
    ...
    expected = {
        ...
        "mismatch": "daily_rolling_mismatch",
